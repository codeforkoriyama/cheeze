...
// OS判定
var _os7:boolean = Cmn.ua.indexOf('os 7_') > 0 && Cmn.ua.indexOf('like mac os x') > 0,
  _os8:boolean = Cmn.ua.indexOf('os 8_') > 0 && Cmn.ua.indexOf('like mac os x') > 0;
